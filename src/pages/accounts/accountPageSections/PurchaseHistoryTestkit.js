...
import WaterTestKit1 from "../cart/testkitcart/testkit_images_videos/Basic.jpg";
import WaterTestKit2 from '../cart/testkitcart/testkit_images_videos/Standard.jpg';
import WaterTestKit3 from '../cart/testkitcart/testkit_images_videos/Plus.jpg';
import WaterTestKit4 from '../cart/testkitcart/testkit_images_videos/Premium.jpg';
import WaterTestKit5 from '../cart/testkitcart/testkit_images_videos/Legionella.jpg';
import WaterTestKit6 from '../cart/testkitcart/testkit_images_videos/Bacteria.jpg';
import WaterTestKit7 from '../cart/testkitcart/testkit_images_videos/Pool.jpg';
...
export default function TestkitCart() {
    ...
    const loadTestkitHistory = async () => {
        const Test_Kit_History = await axios.get(
            `http://localhost:8080/testkit/purchase-history/${localStorage.getItem("user_ID")}`
        );
    ...
    return (
        <div>
            <center>
                <h1>Your Test Kit Purchase History</h1>
            </center>
            <table className="Test_Kit_Table">
                ...
                {TestkitHistory.map((TestkitCartItems, index) => (
                    <tr>
                        ...
                        <td>{TestkitCartItems.usestatus ? "Activated" : "Not Activated"}</td>
                    </tr>
                ))}
            </table>
        </div>
