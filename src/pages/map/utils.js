function OSGB36toWGS84 (E, N) {
    ...
    while (N - N0 - M >= 0.00001) { //Accurate to 0.01mm
        ...
        const M2 = (3 * n + 3 * Math.pow(n, 2) + (21. / 8) * Math.pow(n, 3)) * Math.sin(lat - lat0) * Math.cos(lat + lat0);
        const M3 = ((15. / 8) * Math.pow(n, 2) + (15. / 8) * Math.pow(n, 3)) * Math.sin(2 * (lat - lat0)) * Math.cos(2 * (lat + lat0));
